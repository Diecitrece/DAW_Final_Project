          ...
          <div className="w-full md:w-1/2 lg:w1/1 p-4">
            ...
            <div className="mb-4">
              ...
              <p className="text-xl ">
                ...
                obcaecati ratione nihil repellat esse mollitia, incidunt
                architecto distinctio? Quod amet eius ex necessitatibus ullam
                tenetur aperiam incidunt corrupti ad nostrum.
              </p>
            </div>
            <div className="mb-4">
